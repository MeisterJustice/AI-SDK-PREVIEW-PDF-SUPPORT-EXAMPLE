...
const TestOption = ({ testType }: { testType: (typeof testTypes)[0] }) => {
  return (
    <Link href={testType.route} key={testType.id}>
      <div className="py-3 px-16 rounded-lg bg-card text-card-foreground flex items-center justify-center gap-3 hover:bg-muted-foreground transition-all duration-300">
